 ...
 */
    ...
    public function generarPdf($id, $outputToBrowser = true)
    {
        ...
        try {
            ...
            $html .= '</td>
            </tr><tr><td colspan="4" style="text-align: center;"><h3>Datos generales:</h3></td></tr>';
            $indiceGenerales = 0;
            $html .= '</table>';
            ...
            if ($result['tipo_cliente_id'] == 1) {
                $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;"><tr><td colspan="2" style="text-align: center;"><h3>Servicios solicitados:</h3></td></tr></table>';
                ...
                $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
                    <td colspan="2" style="text-align: center;"><h3>Contratación:</h3></td>
                </tr></table>';
                $html .= '
                ...
                $html .= '</table>';
                $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
                <td colspan="2" style="text-align: center;"><h3>Facturación:</h3></td>
            </tr></table>';
                ...
                $html .= '</table>';
                $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
                <td colspan="2" style="text-align: center;"><h3>Seguridad y salud en el trabajo:</h3></td>
            </tr></table>';
                ...
                $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
                <td colspan="2" style="text-align: center;"><h3>Cargos:</h3></td>
            </tr></table>';
                $html .= '<table style="border: 1px #000000 solid; padding:10px; border-collapse: collapse;">';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Información financiera:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Representantes legales:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Miembros de la junta directiva:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Calidad tributaria:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Datos del contador:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Datos del tesorero:</h3></td>
        </tr></table>';
            $html .= '<table style="border: 1px #000000 solid; padding:10px; border-collapse: collapse;">';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Último periodo contable:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Operaciones internacionales:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Referencias bancarias:</h3></td>
        </tr></table>';
            ...
            $html .= '</table>';
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Referencias comerciales:</h3></td>
        </tr></table>';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Declaraciones y autorizaciones:</h3></td>
            </tr></table>';
            ...
            $html .= '</table>';
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Datos de personas expuestas politicamente:</h3></td>
            </tr></table>';
            $html .= '<table style="border: 1px #000000 solid; padding:10px; border-collapse: collapse;">';
            ...
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Declaración de origen de fondos:</h3></td>
            </tr></table>';
            ...
            $html .= '</table>';
            $html .= '<table style="border: 1px #000000 solid; padding:5px; border-collapse: collapse;">  <tr>
            <td colspan="2" style="text-align: center;"><h3>Autorización de Tratamiento de Datos Personales:</h3></td>
        </tr></table>';
    ...
    public function generarContratoPdf($id, $outputToBrowser = true)
    {
        ...
        try {
            ...
            // Desactivar encabezado predeterminado
            $pdf->setPrintHeader(false);

            // Establecer márgenes iniciales
            $margen_izquierdo = 15;
            $margen_superior = 40;
            $margen_derecho = 15;
            $pdf->SetMargins(0, 0, 0);
            ...
            // Agregar la imagen de fondo solo en la primera página
            $url2 = public_path('/upload/MEMBRETE.png');
            $pdf->Image($url2, 0, 0, $pdf->getPageWidth(), $pdf->getPageHeight(), '', '', '', false, 300, '', false, false, 0);
        ...
        <td colspan="2" style="text-align: center;"><h4>EMPRESA USUARIA (EU) Radicado: ' . $contrato_data['radicado'] . '</h4></td>
            ...
            for ($i = 1; $i <= $totalPages; $i++) {
                if ($i > 1) {
                    ...
                    // Agregar la imagen de fondo en las páginas restantes
                    $pdf->Image($url2, 0, 0, $pdf->getPageWidth(), $pdf->getPageHeight(), '', '', '', false, 300, '', false, false, 0);
                    $pdf->setMargins(15, 40, 15);
                    $pdf->SetAutoPageBreak(true, 40);
                }
